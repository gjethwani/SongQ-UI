$(function () {
    ...
    $(window).on('load', function (event) {
        ...
        xhttp.onreadystatechange = function() {
            if (this.readyState == 4) {
                if (this.status === 200 && window.location.pathname !== "/home" && window.location.pathname !== '/feedback') {
    ...
    $(window).on('scroll', function (event) {
        ...
        if (scroll < 20) {
            ...
            $("#login-nav-button").addClass("main-btn")
            $("#login-nav-button").removeClass("main-btn-scroll")
            $(".navbar .navbar-brand img").attr("src", "logo.png")
            $("#main-logo").removeClass("logo-scrolled-down")
        } else {
            $(".navbar-area").addClass("sticky");
            $("#login-nav-button").addClass("main-btn-scroll")
            $("#login-nav-button").removeClass("main-btn")
            $("#main-logo").addClass("logo-scrolled-down")
        }
    });
